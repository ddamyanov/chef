...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "thedpd-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/thedpd"
  #   chef.validation_client_name = "thedpd-validator"
  #   chef.validation_key_path = ".chef/thedpd-validator.pem"
  # end
end
